<template>
  <div class="container">
    <div style="width: 400px; padding: 30px; background-color: white; border-radius: 20px;">
      <div style="text-align: center; font-size: 20px; margin-bottom: 20px; color: #333">欢迎登录网上购物商城</div>
      <el-form :model="form" :rules="rules" ref="formRef">
        ...
        <div style="display: flex; align-items: center">
          <div style="flex: 1; margin-right: 20px; cursor: pointer;" class="hover-text" @click="handleClick">返回首页</div>
