<template>
  ...
  <el-table-column prop="description" label="商品描述" align="center">
    <template v-slot="scope">
      <el-button type="success" @click="viewEditor(scope.row.description)" size="mini">点击查看</el-button>
    </template>
  </el-table-column>
  
  <el-table-column prop="price" label="商品价格" show-overflow-tooltip align="center"></el-table-column>
  <el-table-column prop="unit" label="计件单位" show-overflow-tooltip align="center"></el-table-column>
  <el-table-column prop="typeName" label="商品分类" show-overflow-tooltip align="center"></el-table-column>
  <el-table-column prop="businessName" label="所属商家" show-overflow-tooltip align="center"></el-table-column>
  <el-table-column prop="count" label="商品销量" show-overflow-tooltip align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleAdd() {   // 新增数据
  if (
    !('ADMIN' === this.user.role) && // 用户不是 ADMIN
    ('BUSINESS' === this.user.role && '审核通过' !== this.user.status) // 但用户是 BUSINESS 且状态不是 审核通过
  ) {
