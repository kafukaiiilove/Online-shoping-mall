<template>
  ...
  <el-table :data="tableData" stripe @selection-change="handleSelectionChange">
    ...
    <el-table-column prop="content" label="评论内容" show-overflow-tooltip align="center"></el-table-column>
    <el-table-column prop="userName" label="评论用户" show-overflow-tooltip align="center"></el-table-column>
    <el-table-column prop="time" label="评论时间" show-overflow-tooltip align="center"></el-table-column>
    <el-table-column prop="businessName" label="商户" show-overflow-tooltip align="center"></el-table-column>
    <el-table-column prop="goodsName" label="商品" show-overflow-tooltip align="center"></el-table-column>
